...
if (isset($_POST["submit"])) {
    ...
    if ($user_validity > 0) {
        ...
        if ($online_status_validity > 0) {
            ...
            header("Location:./Dashboard/General_Message/General_Message.php");
...
<body>
  ...
  <div class="flex-row">
    <input id="username" class='lf--input' placeholder='Nom utilisateur' type='text' name="txtUsername">
  </div>
  <div class="flex-row">
    <input id="password" class='lf--input' placeholder='Mot de passe' type='password' name="txtPassword">
  </div>
  <input class='lf--submit' type='submit' value='Se connecter' name="submit" id="btnSubmit">

	  <p style="font-size:.7em;color:#2dc6bf;text-align:center;cursor:hand"><u><a style="color:#2dc6bf" href="users_signup.php">S'inscrire</a></u></p>
