...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="Private_Share.php"><img src="../img/remove-user.png" class="navimg img-responsive" /><span class="nav-writting">Partage privé</span></a></li>
    ...
    <div class="main_content">
      ...
      <div class="first_box">
       ...
       <div class = "panel-heading phead">
        <h2 class = "panel-title ptitle">Selectionner &nbsp; Utilisateurs</h2>
       </div>
      ...
      <div class="second_box">
        ...
        <div class = "panel panel-adjusted">
       <div class = "panel-heading phead">
        <h2 class = "panel-title ptitle">Utilisateurs &nbsp; Sélectionnés</h2>
       </div>
    ...
    <!-- pour afficher le troisieme bandeau pour uploader on deselectionne le suivant -->
