...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="General_Message.php"><img src="../img/chat-1.png" class="navimg img-responsive" /><span class="nav-writting">Discussion publique</span></a></li>

            <li><a href="../Private_Message/Private_Message.php"><img src="../img/send-file.png" class="navimg img-responsive" /><span class="nav-writting">Discussion privé</span></a></li>


            <li><a href="../Private_Share/Private_Share.php"><img src="../img/remove-user.png" class="navimg img-responsive" /><span class="nav-writting">Partage privé</span></a></li>

            <li><a href="../General_announcement/general_announcement.php"><img src="../img/log-file-format-1.png" class="navimg img-responsive" /><span class="nav-writting">Annonces générales</span></a></li>
            
           <li onclick="Logout()"><a href="../../index.php"><img src="../img/logout.png" class="navimg img-responsive" /><span class="nav-writting">Se déconnecter</span></a></li>
        </ul>
    </div>
    ...
    <!-- Main Content Starts Here -->
      ...
      <div id="Main_Chat_Box" class="col-md-8">
        ...
        <div id="get_chatting_user_name">
          <div style="font-weight:bold;font-size:1.2em;float:left;color:rgba(69, 162, 255, 0.93)">Discussions générales</div>
      ...
      <div id="Right_side_bar" class="col-md-3">
        ...
        <div><span class="right_side_logo"> Aujourd'hui <hr></span>
    ...
    <textarea id="text_area" placeholder="Taper quelque chose ici"></textarea><img src="../img/send.png" alt="Send Image" id="send_button"/>
