...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="Private_Message.php"><img src="../img/send-file.png" class="navimg img-responsive" /><span class="nav-writting">Discussion privé</span></a></li>
    ...
    <div class="container-fluid" id="main_content">
      ...
      <div id="Get_Online_Users" class="col-md-3">
 ...
 <!--     <div id="Main_Chat_Box" class="col-md-7">
    ...
    -->
      ...
      <div id="Right_siclass="col-md-7"de_bar" class="col-md-7">
      </br>
        
        <div ><span class="right_side_logo"> Profil </span> <hr></div>
        <div id="get_users_profile" class="col-md-7">
