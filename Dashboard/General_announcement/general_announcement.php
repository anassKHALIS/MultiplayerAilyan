...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a style="border-left:4px solid rgba(69, 162, 255, 0.93); border-radius:10px" href="#"><img src="../img/log-file-format-1.png" class="navimg img-responsive" /><span class="nav-writting">Annonces générales</span></a></li>
    ...
    <div class="right-page">
      ...
      <span style="text-align:center;font-weight:bold">ENVOYER ANNONCE</span>
      <hr>
    </div>

    <form method="post" action="">
      <div class="form-group">
           <label for="txt_title" class="msg_title">Titre </label>
    ...
    <button class="btn btn-primary" id="btn_post">Envoyer</button>
    </div>
  </form>
    </div>
    </div>
